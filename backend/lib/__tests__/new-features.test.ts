 ...
 * New Features Tests
 * 
 * Tests for subcategories and investment reminders
 */
...
// ============================================================================
// TEST 1: Subcategories exist in sample data
// ============================================================================
...
// Verify subcategory budgets sum up correctly (or close to parent budget)
...
// ============================================================================
// TEST 2: Investment preferences exist in sample data
// ============================================================================
...
// ============================================================================
// TEST 3: Investment reminder generation
// ============================================================================
...
if (!reminder) {
  ...
  // Verify non-intrusiveness - urgency should not be 'high' for normal conditions
...
// ============================================================================
// TEST 4: Budget analysis with subcategories
// ============================================================================
...
// Check that categories have subcategory data
...
// ============================================================================
// TEST 6: Reminder respects auto-invest setting
// ============================================================================

console.log('📊 TEST 6: Auto-invest disables reminders');
console.log('-'.repeat(60));

const autoInvestUser: UserProfile = {
  ...sampleUser,
  preferences: {
...
// ============================================================================
// TEST 7: Reminder respects 'none' frequency
// ============================================================================

console.log('📊 TEST 7: "None" frequency disables reminders');
console.log('-'.repeat(60));

const noRemindersUser: UserProfile = {
  ...sampleUser,
  preferences: {
    ...sampleUser.preferences,
    investmentPreferences: {
...
// ============================================================================
// TEST 8: Non-intrusive reminder messages
// ============================================================================

console.log('📊 TEST 8: Non-intrusive reminder messages');
console.log('-'.repeat(60));

// Check that the message doesn't contain aggressive/pushy language
...
if (reminder2 && reminder2.message) {
  ...
  const hasPushyLanguage = pushyPhrases.some(phrase => 
    reminder2.message.toLowerCase().includes(phrase.toLowerCase())
  );
