/**
 * Ingest FRED indicator descriptions (NOT the data itself).
 * The data is fetched live; descriptions help with understanding and are embedded.
 */
...
async function ingestFREDDescriptions(): Promise<void> {
  try {
