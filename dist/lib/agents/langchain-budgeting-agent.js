...
export class LangChainBudgetingAgent extends LangChainBaseAgent {
    agentName = 'Budgeting Agent';
    schema = BudgetingAnalysisSchema;
    constructor() {
        super(0.2);
    }
    systemPrompt = `You are an expert budgeting analyst specializing in personal finance.
...
Output your analysis in the specified JSON format.`;
    buildAnalysisPrompt(context) {
        ...
        const totalMonthlyExpenses = user.fixedExpenses.reduce((sum, e) => sum + e.amount, 0) +
...
//# sourceMappingURL=langchain-budgeting-agent.js.map