...
export class LangChainGuardrailAgent extends LangChainBaseAgent {
    agentName = 'Guardrail Agent';
    schema = GuardrailAnalysisSchema;
    constructor() {
        super(0.0);
    }
    systemPrompt = `You are a strict compliance and risk management agent for personal finance.
...
//# sourceMappingURL=langchain-guardrail-agent.js.map