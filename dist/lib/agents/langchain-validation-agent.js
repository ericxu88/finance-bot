...
import { ValidationAnalysisSchema } from './schemas.js';
export class LangChainValidationAgent extends LangChainBaseAgent {
    agentName = 'Validation Agent';
    schema = ValidationAnalysisSchema;
    constructor() {
        super(0.4);
    }
    systemPrompt = `You are a meta-analyst responsible for CONSISTENCY and RISK FLAGS — you are NOT the final decision maker.
...
Output a comprehensive validation in the specified JSON format.`;
    async analyzeWithAgentOutputs(context, agentAnalyses) {
        return this.analyze({
            ...context,
            ...agentAnalyses
        });
    ...
    buildAnalysisPrompt(context) {
        const { action, historicalMetrics, budgetingAnalysis, investmentAnalysis, guardrailAnalysis } = context;
        return `
...
//# sourceMappingURL=langchain-validation-agent.js.map