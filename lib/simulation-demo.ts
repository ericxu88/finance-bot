 ...
 * 
 * Interactive demonstration of all simulation functions using Sarah's profile.
 */
...
// ============================================================================
// SCENARIO 2: Invest $500 in Taxable Account
// ============================================================================
...
// ============================================================================
// SCENARIO 3: Spend $500 on Dining
// ============================================================================
...
const diningBudget = spendSimulation.scenarioIfDo.budgetImpacts.find(
  bi => bi.categoryId === 'cat_dining'
);
if (diningBudget) {
...
// ============================================================================
// SCENARIO 4: Compare All Three Options
// ============================================================================
...
// ============================================================================
// SCENARIO 5: Test Guardrail Violation
// ============================================================================

console.log('🚫 SCENARIO 5: Test Guardrail Violation');
console.log('-'.repeat(70));

// Try to save $2,500 (would violate checking minimum of $1,000)
...
// ============================================================================
// SCENARIO 6: Investment Growth Calculator
// ============================================================================
...
amounts.forEach(amount => {
  ...
  console.log(
    `$${amount.toString().padStart(5)} │ $${values[0]?.toFixed(2).padStart(8)} │ ` +
